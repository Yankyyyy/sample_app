...
def execute(filters=None):
    ...
    account_list = get_accounts(filters, 15, 'VAT', ['input rcm', 'output rcm'])
    total_row, return_total_row = get_account_wise_tax_invoice(filters, invoice_name, account_list)
    data.append({
        "sr_no":"7",
    ...
    total_row, return_total_row = get_account_wise_tax_invoice(filters, "journal", account_list)
    data.append({
    ...
    account_list = get_accounts(filters, 5, 'VAT', ['input rcm', 'output rcm'])
    total_row, return_total_row = get_account_wise_tax_invoice(filters, invoice_name, account_list)
    data.append({
        "sr_no":"7.1",
    ...
    account_list = get_accounts(filters, 15, "input rcm")
    total_row, return_total_row = get_account_wise_tax_invoice(filters, invoice_name, account_list)
    data.append({
        "sr_no":"9",
    ...
    account_list = get_accounts(filters, 5, "input rcm")
    total_row, return_total_row = get_account_wise_tax_invoice(filters, invoice_name, account_list)
    data.append({
        "sr_no":"9.1",
